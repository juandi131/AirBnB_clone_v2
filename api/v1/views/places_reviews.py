...
def review_by_place(place_id):
    """function that return review objects by place"""
...
def show_review(review_id):
    """endpoint of returning review object"""
...
def delete_review(review_id):
    """endpoint of deleting review object"""
    review = storage.get(Review, review_id)
    if review is None:
        abort(404)
    review.delete()
...
def insert_review(place_id):
    """endpoint of inserting review object"""
    place = storage.get(Place, place_id)
    if place is None:
        abort(404)
...
def update_review(review_id):
    """endpoint of updating review object"""
    review = storage.get(Review, review_id)
    if review is None:
        abort(404)
    res = request.get_json()
